...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "pop-os";
    repo = "cosmic-player";
    rev = "b8000c5fffa8462a156dcc26609f8b98492d6180";
    hash = "sha256-AWxEfRFBjAHP3CJH1ux3lLZK3x8pcReLraDRjUuS9do=";
  };

  cargoHash = "sha256-X6EVu39gx/N9PraNudTJve9pmukFJ4qegSBVIkpwIvU=";
